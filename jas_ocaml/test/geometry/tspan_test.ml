...
let tspan_of_json v : tspan =
  ...
  let opt k f = field k f None in
  {
    ...
    jas_word_spacing_min = opt "jas_word_spacing_min" opt_float;
    jas_word_spacing_desired = opt "jas_word_spacing_desired" opt_float;
    jas_word_spacing_max = opt "jas_word_spacing_max" opt_float;
    jas_letter_spacing_min = opt "jas_letter_spacing_min" opt_float;
    jas_letter_spacing_desired = opt "jas_letter_spacing_desired" opt_float;
    jas_letter_spacing_max = opt "jas_letter_spacing_max" opt_float;
    jas_glyph_scaling_min = opt "jas_glyph_scaling_min" opt_float;
    jas_glyph_scaling_desired = opt "jas_glyph_scaling_desired" opt_float;
    jas_glyph_scaling_max = opt "jas_glyph_scaling_max" opt_float;
    jas_auto_leading = opt "jas_auto_leading" opt_float;
    jas_single_word_justify = opt "jas_single_word_justify" opt_string;
    jas_hyphenate_min_word = opt "jas_hyphenate_min_word" opt_float;
    jas_hyphenate_min_before = opt "jas_hyphenate_min_before" opt_float;
    jas_hyphenate_min_after = opt "jas_hyphenate_min_after" opt_float;
    jas_hyphenate_limit = opt "jas_hyphenate_limit" opt_float;
    jas_hyphenate_zone = opt "jas_hyphenate_zone" opt_float;
    jas_hyphenate_bias = opt "jas_hyphenate_bias" opt_float;
    jas_hyphenate_capitalized = opt "jas_hyphenate_capitalized" opt_bool;
