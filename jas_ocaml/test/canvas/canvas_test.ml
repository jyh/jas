...
let main_window, toolbar_fixed, notebook, _dock_box, _workspace_layout, _refresh_dock = Jas.Canvas.create_main_window ~get_model:(fun () -> model) ~get_fill_on_top:(fun () -> true) ~on_open:(fun _ -> ()) ()
