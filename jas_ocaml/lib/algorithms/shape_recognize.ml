...
let recognized_to_element shape template =
  ...
  | Recognized_line { a = (x1, y1); b = (x2, y2) } ->
    Element.Line { name = None; id = None; x1; y1; x2; y2; stroke = a.a_stroke; width_points = [];
                   opacity = a.a_opacity;
  ...
  | Recognized_triangle { pts = (p1, p2, p3) } ->
    Element.Polygon { name = None; id = None; points = [p1; p2; p3]; fill = a.a_fill; stroke = a.a_stroke;
  ...
  | Recognized_rectangle { x; y; w; h } ->
    Element.Rect { name = None; id = None; x; y; width = w; height = h; rx = 0.0; ry = 0.0;
  ...
  | Recognized_round_rect { x; y; w; h; r } ->
    Element.Rect { name = None; id = None; x; y; width = w; height = h; rx = r; ry = r;
                   fill = a.a_fill; stroke = a.a_stroke; opacity = a.a_opacity;
                   transform = a.a_transform; locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                     fill_gradient = None;
                     stroke_gradient = None;
  ...
  | Recognized_circle { cx; cy; r } ->
    Element.Circle { name = None; id = None; cx; cy; r; fill = a.a_fill; stroke = a.a_stroke;
                     opacity = a.a_opacity; transform = a.a_transform;
                     locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                       fill_gradient = None;
                       stroke_gradient = None;
  ...
  | Recognized_ellipse { cx; cy; rx; ry } ->
    Element.Ellipse { name = None; id = None; cx; cy; rx; ry; fill = a.a_fill; stroke = a.a_stroke;
                      opacity = a.a_opacity; transform = a.a_transform;
                      locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                        fill_gradient = None;
                        stroke_gradient = None;
  ...
  | Recognized_arrow { tail; tip; head_len; head_half_width; shaft_half_width } ->
    ...
    Element.Polygon { name = None; id = None; points; fill = a.a_fill; stroke = a.a_stroke;
                      opacity = a.a_opacity; transform = a.a_transform;
                      locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                        fill_gradient = None;
                        stroke_gradient = None;
  ...
  | Recognized_scribble { points } ->
    Element.Polyline { name = None; id = None; points; fill = None; stroke = a.a_stroke;
                       opacity = a.a_opacity; transform = a.a_transform;
                       locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                         fill_gradient = None;
                         stroke_gradient = None;
  ...
  | Recognized_lemniscate { center; a = la; horizontal } ->
    ...
    Element.Path { name = None; id = None; d; fill = a.a_fill; stroke = a.a_stroke;
                   width_points = [];
                   opacity = a.a_opacity; transform = a.a_transform;
                   locked = a.a_locked; visibility = a.a_visibility; blend_mode = Element.Normal; mask = None;
                     fill_gradient = None;
