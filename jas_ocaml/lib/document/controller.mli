...
class controller : ?model:Model.model -> unit -> object
  ...
  method apply_concept_operation : Document.element_path -> Yojson.Safe.t -> unit
  method promote_to_concept :
    Document.element_path -> string -> Yojson.Safe.t -> Element.transform -> unit
