...
impl ToolKind {
    ...
    pub fn cursor_css(&self) -> &'static str {
        match self {
            ...
            ToolKind::Hand => "grab",
            // Zoom: magnifier with plus by default. Alt-held
            // dynamically flips to zoom-out via the tool's
            // cursor_css_override. Per ZOOM_TOOL.md §Cursor states.
            ToolKind::Zoom => "zoom-in",
            ToolKind::Type => {
